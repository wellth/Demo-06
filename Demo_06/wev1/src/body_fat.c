...
GtkWidget *bodyFatLabel,*entry1,*entry2, *test2_msg, *test2_timer_label;
static GtkWidget *t2_button1, *t2_button2, *t2_button3, *t2_button4, *t2_button5, *t2_home_button;
static GtkWidget *t2b_button1, *t2b_button5, *t2b_home_button;
...
void reset_test2_results() {
	gtk_label_set_label (test2_timer_label, "0 M: 0 S");
	gtk_label_set_label (bodyFatLabel, "**%");
	//gtk_label_set_label (test2_msg, "System message");
}

void test2_button_set_state(int bool_val){
	gtk_widget_set_sensitive(t2_button1, bool_val);
	gtk_widget_set_sensitive(t2_button2, bool_val);
	gtk_widget_set_sensitive(t2_button3, bool_val);
	gtk_widget_set_sensitive(t2_button4, bool_val);
	gtk_widget_set_sensitive(t2_button5, bool_val);
...
void show_window_test2_b()
{
	...
	if(isQuickWellthCheck)
		gtk_widget_hide(t2b_button1);
	else
		gtk_widget_hide(t2b_home_button);
