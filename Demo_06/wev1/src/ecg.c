...
GtkWidget *label_sys_msg, *label_timer_label;
static GtkWidget *t5_button1, *t5_button2, *t5_button3, *t5_button4, *t5_button5, *t5_home_button;
...
******/
	...
	label_timer_label = GTK_WIDGET (gtk_builder_get_object (Test5Builder, "timer_label"));
